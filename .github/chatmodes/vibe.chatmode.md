<!-- Fichier généré automatiquement par l'extension Vibe+ Copilot Mode. -->
<!-- Si vous éditez manuellement ce fichier, vous pouvez désactiver la réécriture automatique via le paramètre (à ajouter) vibeplus.autoApplyOnStartup:false -->
